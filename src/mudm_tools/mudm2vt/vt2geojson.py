...
geometry_types = {0: "Unknown", 1: "Point", 2: "LineString", 3: "Polygon", 4: "MultiLineString"}
...
def vt2geojson(tile, extent=4096):
    ...
    geojson_features = [vt_feature2geojson_feature(feature, size, x0, y0) for feature in features]
