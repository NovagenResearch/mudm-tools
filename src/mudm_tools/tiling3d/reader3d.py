"""TileReader3D — decode .pbf3 files back to features.

Reads tiles generated by TileGenerator3D and can reconstruct
a MuDM FeatureCollection from a zoom level.
"""
...
def decode_tile(data: bytes) -> list[dict]:
    """Decode a .pbf3 tile from protobuf bytes.
...
class TileReader3D:
    ...
    def read_tile(
        ...
        """
        tile_path = self._base_dir / str(z) / str(x) / str(y) / f"{d}.pbf3"
    ...
    def tiles2microjson(
        ...
        """Reconstruct a MuDMFeatureCollection from tiles at a zoom level.
