...
class Point(BaseModel):
    ...
    coordinates: List[float] = Field(..., max_length=3, min_length=2, title="Coordinates")
...
class Properties(BaseModel):
    ...
    multiNumerical: Optional[Dict[str, List[float]]] = Field(None, title="Multi Numerical")
...
class Multiscale(BaseModel):
    ...
    pixelsPerUnit: Optional[List[float]] = Field(None, alias="pixelsPerUnit", title="Pixelsperunit")
...
class MuDM(BaseModel):
    __root__: Union[
        ...
        MultiPolygon,
        GeometryCollection,
    ] = Field(..., description="The root object of a MuDM file", title="MuDM")
